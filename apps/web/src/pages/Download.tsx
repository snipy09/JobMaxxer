  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-white text-ink-950 font-sans flex flex-col antialiased selection:bg-ink-950 selection:text-white">
      ...
      <div className="border-b border-ink-100 bg-ink-50 px-4 py-2 text-center text-[11px] sm:text-xs text-ink-600 font-mono tracking-tight flex items-center justify-center gap-2">
        ...
        <span>Official Download Portal · Nomadic v1.0.5 Windows x64 Native Release</span>
      </div>
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 pt-12 sm:pt-16 pb-20 space-y-16">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-4 animate-in">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-ink-50 border border-ink-200 rounded-full text-[11px] sm:text-xs font-mono text-ink-600 shadow-fine">
            ...
            <span>Version 1.0.5 Verified Release</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-3 pt-4 border-t border-ink-100">
              ...
              <a
                href="https://github.com/snipy09/JobMaxxer/releases/download/v1.0.5/Nomadic.Setup.1.0.5.exe"
                onClick={() => handleDownloadClick('https://github.com/snipy09/JobMaxxer/releases/download/v1.0.5/Nomadic.Setup.1.0.5.exe', 'Nomadic.Setup.1.0.5.exe')}
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                <a
                  href="https://github.com/snipy09/JobMaxxer/releases/download/v1.0.5/Nomadic.1.0.5.exe"
                  onClick={() => handleDownloadClick('https://github.com/snipy09/JobMaxxer/releases/download/v1.0.5/Nomadic.1.0.5.exe', 'Nomadic.1.0.5.exe')}
                ...
                <a
                  href="https://github.com/snipy09/JobMaxxer/releases/download/v1.0.5/Nomadic-1.0.5-win.zip"
                  onClick={() => handleDownloadClick('https://github.com/snipy09/JobMaxxer/releases/download/v1.0.5/Nomadic-1.0.5-win.zip', 'Nomadic-1.0.5-win.zip')}
                  className="py-2.5 px-3 bg-ink-50 hover:bg-ink-100 border border-ink-200 text-ink-800 rounded-lg text-[11px] font-semibold flex items-center justify-center gap-1.5 transition-colors text-center"
              ...
              <div className="flex items-center justify-between text-[10px] text-ink-400 font-mono px-1">
                <span>Release: v1.0.5 Stable</span>
        ...
        <div className="animate-in bg-ink-50 border border-ink-200 rounded-3xl p-6 sm:p-10 shadow-fine space-y-8 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-xs">
            <div className="bg-white border border-ink-200 p-5 rounded-2xl space-y-2.5 shadow-fine">
              ...
              <p className="text-ink-600 leading-relaxed">
                Click the download button above to get <code className="bg-ink-100 px-1 py-0.5 rounded text-[11px]">Nomadic.Setup.1.0.5.exe</code> (or the Portable Zip).
              </p>
            </div>
