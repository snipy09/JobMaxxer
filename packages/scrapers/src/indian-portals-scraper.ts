...
const INDIAN_TECH_CAREER_ROSTER: Array<{
  ...
  { title: 'Cloud Backend Engineer (Distributed Systems)', company: 'Elastic', location: 'India / Remote', salary: '₹22 LPA - ₹40 LPA', exp: '2-5 yrs', skills: 'Java, Go, Elasticsearch, Distributed Systems', applyUrl: 'https://boards.greenhouse.io/elastic', source: 'Direct ATS' },
