  ...
  const syncRoleContacts = () => {
    ...
    const tailoredLeads: OutreachContact[] = [
      ...
      },
      {
        name: 'Alex Rivera',
        company: 'Linear',
        role: `Hiring Manager - ${desiredTitle}`,
      ...
      },
      {
        name: 'Elena Rostova',
        company: 'Supabase',
        role: `Engineering Manager (${desiredTitle})`,
        email: 'elena@supabase.io',
        verificationStatus: 'valid',
        sentStatus: 'unsent',
      },
      {
      ...
      },
      {
        name: 'Priya Sharma',
        company: 'GitHub',
        role: `Principal Engineer - Core Platform`,
        email: 'psharma@github.com',
        verificationStatus: 'valid',
        sentStatus: 'unsent',
      },
      {
